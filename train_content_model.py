...
Kullanım:
    python train_content_model.py                          # ERSIN Varsayılan parametrelerle
    python train_content_model.py --epochs 15 --batch-size 32 --learning-rate 0.0005
    python train_content_model.py --dry-run               # ERSIN Sadece analiz
    python train_content_model.py --min-samples 50        # ERSIN Minimum örnek sayısı
"""
...
# ERSIN Proje root'unu sys.path'e ekle
...
def main ():
    ...
    epilog ="""
Örnekler:
  python train_content_model.py                           # ERSIN Varsayılan parametreler
  python train_content_model.py --dry-run                # ERSIN Sadece analiz
    ...
    # ERSIN Flask uygulama bağlamı oluştur
        ...
        with app .app_context ():
            ...
            if not recommended and not args .force :
                ...
                # ERSIN 2. Training parametreleri hazırla
            training_params ={
            'epochs':args .epochs ,
