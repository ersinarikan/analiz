...
"""
import eventlet
# NOTE: PyTorch/OpenCLIP gibi native kütüphaneler eventlet'in thread patch'i ile
# bazı ortamlarda segfault'a yol açabiliyor. Bu nedenle thread patch kapalı tutulur.
