...
def start_training ():
    ...
    try :
        ...
        # ERSIN Özel parametreler
        if training_params :
        # ERSIN Güvenlik kontrolü - makul limitler
        ...
        try :
            ...
            emit_training_started (session_id ,'CLIP',100 )# ERSIN Yaklaşık sample sayısı
        except Exception as ws_err :
            logger .warning (f"WebSocket training started event hatası: {str (ws_err )}")

            # ERSIN Training'i başlat
        ...
        # ERSIN WebSocket ile training tamamlanma bildirimi
            try :
                ...
                session_id ,# ERSIN Bizim oluşturduğumuz session_id'yi kullan
                'CLIP Model',
                result ['performance']
                )
            except Exception as ws_err :
            ...
            'training_session_id':session_id ,# ERSIN Bizim session_id'yi döndür
...
def get_training_history ():
    ...
    try :
        ...
        limit =min (limit ,100 )# ERSIN Maksimum 100 kayıt
...
def get_detailed_statistics ():
    ...
    try :
        ...
        # ERSIN CLIP statistics
        clip_stats =clip_service .get_training_statistics ()

        # ERSIN Training readiness
        readiness =content_service .analyze_training_readiness ()

        # ERSIN Combined statistics
        combined_stats ={
...
def test_training_pipeline ():
    ...
    try :
        _ = ContentTrainingService ()  # init if needed later
        clip_service =ClipTrainingService ()

        # ERSIN Test verilerini hazırla
...
def analyze_feedback_for_training ():
    ...
    try :
        ...
        # ERSIN Sadece feedback analizini çalıştır
