    ...
    try :
        ...
        # ERSIN Otomatik temizlik yap
            try :
                ...
                # ERSIN Temizlik konfigürasyonu (daha agresif)
                cleanup_config ={
                'content_feedback_records':50 ,# ERSIN İçerik için daha az kayıt sakla
                'ensemble_content_versions':2 ,# ERSIN Sadece 2 ensemble versiyonu sakla
                'unused_frames_days':7 ,# ERSIN 7 gün önceki frame'leri temizle
                'vacuum_database':True # ERSIN VT optimize et
                }

                # ERSIN Sadece content ile ilgili temizlik yap
                cleanup_operations =[]

                # ERSIN 1. Content feedback temizliği
                ...
                # ERSIN 2. Content ensemble dosya temizliği
                ...
                # ERSIN 3. Kullanılmayan frame temizliği
                ...
                if cleanup_config ['vacuum_database']:
                    ...
                    # ERSIN Temizlik sonuçlarını özetle
                total_cleaned =0 
                cleanup_summary =[]
                ...
                # ERSIN Temizlik hatası olsa da ensemble yenileme başarılı
                return jsonify ({
                "success":True ,
                "message":"Ensemble corrections refreshed successfully",
                "age_corrections":result ['age_corrections'],
...
def get_ensemble_model_stats (model_type ):
    ...
    try :
        ...
        if model_type =='age':
            ...
            # ERSIN Ensemble-aware age model stats
            stats ={
            "model_type":"age",
            ...
            # ERSIN Training info (replaced ile ensemble info)
            "training_samples":ensemble_stats ['people_corrections']+ensemble_stats ['pseudo_corrections'],
            "last_refresh":"Available",# ERSIN Replace ile actual timestamp
            "training_method":"Ensemble Lookup",

            # ERSIN Base model info
            "base_model":{
            ...
            # ERSIN Real-time age distribution from feedback database
            "age_distribution":service .get_real_age_distribution (),

            # ERSIN Real-time error distribution based on ensemble performance
            "error_distribution":service .get_real_error_distribution ()
            }

        else :# ERSIN content/clip
...
def get_ensemble_versions (model_type ):
    ...
    try :
        ...
        # ERSIN ModelVersion tablosundan ensemble versiyonlarını getir
