...
MODELS = {
    ...
    'age_model': {
        ...
        'gdrive_id': '1YCox_4kJ-BYeXq27uUbasu--yz28zUMV',  # Örnek Google Drive ID
...
def main():
    ...
    # 'all' seçeneği varsa tüm modelleri seç
    ...
    # Storage model dizini için de aynısını yap
    ...
    for model_key in models_to_download:
        ...
        # Eğer dosya zaten varsa ve force bayrağı set edilmemişse atla
        ...
        if dest_file.endswith(('.zip', '.tar.gz', '.tgz', '.bz2')):
            ...
            # .bz2 dosyaları için orijinal arşivi sil
            if dest_file.endswith('.bz2'):
                os.remove(dest_file)
        
        # Storage model klasörüne kopyala (bazı modeller için)
